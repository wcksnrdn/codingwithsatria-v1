...
const AnimatedSection: React.FC<AnimatedSectionProps> = ({ 
  ...
  const currentStyle = isVisible
    ...
    : hasAnimated
    ? { ...baseStyle, opacity: 0, transform: 'translateY(-20px)', transition: 'all 0.6s ease-in' }
    : baseStyle;
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-[90%] flex-col items-start justify-center lg:max-w-[1212.8px]">
        ...
        <AnimatedSection delay={1.0} className="flex w-full flex-col justify-between gap-4 lg:max-w-[1200px]">
